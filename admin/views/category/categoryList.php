        ...
        <div class="shadow bg-white pb-5 mt-4 ms-4 mb-4 col-md-11" style="width: 96%;">
            ...
            <div class="pb-5 mt-4 ms-2 mb-4 ">
                <table class="table table-hover ">
                        ...
                        <?php
                            foreach($categoryList as $item){
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle"><?=$item->categorie_name?></td>
                                    <td class="text-center align-middle">
                                    <img src="<?= '../' . IMAGE_PATH_CATE . $item->categorie_image ?>" alt="" style="width: 40%;">
                                    </td>
                                    <td class="text-center align-middle">
                                        <form action="" method="post">
                                            <a href="?act=update-cate&id=<?= $item->categorie_id; ?>">
                                                <button type="button" class="btn btn-outline-primary">
                                                    <i class="lni lni-pencil"></i>
                                                </button>
                                            </a>
                                            <a onclick="return confirm ('Bạn có chắc chắn muốn xóa danh mục này không!')" href="?act=delete-cate&id=<?= $item->categorie_id ?>">
                    ...
                    <button type="submit" class="btn btn-info"><a href="?act=add-category" class="text-light">Nhập thêm</a></button>
                    </form>
            </div>
