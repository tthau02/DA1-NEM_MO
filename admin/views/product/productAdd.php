        ...
        <div class="shadow bg-white pb-5 mt-4 ms-4 mb-4 col-md-11" style="width: 96%;">
            ...
            <form class="pb-5 mt-4 ms-4 mb-4 col-md-11" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mt-2 mb-3"  name="productName" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="productImage">Giá</label>
                    <input type="number" class="form-control mt-2 mb-3" name="product_price">
                </div>

                <div class="form-group">
                    <label for="productDesc">Mô tả</label>
                    <input type="text" class="form-control mt-2 mb-3" name="productDesc">
                </div>
